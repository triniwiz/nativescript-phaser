...
function preload() {
    ...
    this.load.image(assets.scene.background.day, '~/examples/games/flappybird/assets/background-day.png')
    this.load.image(assets.scene.background.night, '~/examples/games/flappybird/assets/background-night.png')
    this.load.spritesheet(assets.scene.ground, '~/examples/games/flappybird/assets/ground-sprite.png', {
        frameWidth: 336,
        frameHeight: 112
    })

    // Pipes
    this.load.image(assets.obstacle.pipe.green.top, '~/examples/games/flappybird/assets/pipe-green-top.png')
    this.load.image(assets.obstacle.pipe.green.bottom, '~/examples/games/flappybird/assets/pipe-green-bottom.png')
    this.load.image(assets.obstacle.pipe.red.top, '~/examples/games/flappybird/assets/pipe-red-top.png')
    this.load.image(assets.obstacle.pipe.red.bottom, '~/examples/games/flappybird/assets/pipe-red-bottom.png')

    // Start game
    this.load.image(assets.scene.messageInitial, '~/examples/games/flappybird/assets/message-initial.png')

    // End game
    this.load.image(assets.scene.gameOver, '~/examples/games/flappybird/assets/gameover.png')
    this.load.image(assets.scene.restart, '~/examples/games/flappybird/assets/restart-button.png')

    // Birds
    this.load.spritesheet(assets.bird.red, '~/examples/games/flappybird/assets/bird-red-sprite.png', {
        frameWidth: 34,
        frameHeight: 24
    })
    this.load.spritesheet(assets.bird.blue, '~/examples/games/flappybird/assets/bird-blue-sprite.png', {
        frameWidth: 34,
        frameHeight: 24
    })
    this.load.spritesheet(assets.bird.yellow, '~/examples/games/flappybird/assets/bird-yellow-sprite.png', {
        frameWidth: 34,
        frameHeight: 24
    })

    // Numbers
    this.load.image(assets.scoreboard.number0, '~/examples/games/flappybird/assets/number0.png')
    this.load.image(assets.scoreboard.number1, '~/examples/games/flappybird/assets/number1.png')
    this.load.image(assets.scoreboard.number2, '~/examples/games/flappybird/assets/number2.png')
    this.load.image(assets.scoreboard.number3, '~/examples/games/flappybird/assets/number3.png')
    this.load.image(assets.scoreboard.number4, '~/examples/games/flappybird/assets/number4.png')
    this.load.image(assets.scoreboard.number5, '~/examples/games/flappybird/assets/number5.png')
    this.load.image(assets.scoreboard.number6, '~/examples/games/flappybird/assets/number6.png')
    this.load.image(assets.scoreboard.number7, '~/examples/games/flappybird/assets/number7.png')
    this.load.image(assets.scoreboard.number8, '~/examples/games/flappybird/assets/number8.png')
    this.load.image(assets.scoreboard.number9, '~/examples/games/flappybird/assets/number9.png')
